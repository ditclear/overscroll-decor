...
import me.everything.overscrolldemo.view.CoordinatorLayoutDemoFragment;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.drawer_item_coor_demo:
                replaceMainFragment(new CoordinatorLayoutDemoFragment(),
                        R.string.coordinator_demo_title);
                break;
        }
