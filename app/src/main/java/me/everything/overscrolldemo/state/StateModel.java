...
import me.everything.overscrolldemo.MyApp;
        ...
        switch (emptyState) {
            case EmptyState.EMPTY:
                return ContextCompat.getDrawable(mContext,
                        R.drawable.ic_cloud_off_lime_300_24dp);
            case EmptyState.NOT_AVAILABLE:
                return ContextCompat.getDrawable(mContext, R.drawable.ic_cloud_off_lime_300_24dp);
            default:
                return null;
        }
    }
