...
public class VerticalOverScrollBounceEffectDecorator extends OverScrollBounceEffectDecoratorBase {
     ...
     * <br/>Touch-drag ratio in 'forward' direction will be set to
     * DEFAULT_TOUCH_DRAG_MOVE_RATIO_FWD.
     * <br/>Touch-drag ratio in 'backwards' direction will be set to
     * DEFAULT_TOUCH_DRAG_MOVE_RATIO_BCK.
     * <br/>Deceleration factor (for the bounce-back effect) will be set to
    ...
    protected static class MotionAttributesVertical extends MotionAttributes {
        ...
        public boolean init(View view, MotionEvent event) {
            ...
            // We must have history available to calc the dx. Normally it's there - if it isn't
            // temporarily,
            ...
            // Allow for counter-orientation-direction operations (e.g. item swiping) to run
            // fluently.
