...
import me.everything.android.ui.overscroll.adapters.CoordinatorLayoutOverScrollDecorAdapter;
...
public class OverScrollDecoratorHelper {
     ...
     * <br/>Only recycler-views using <b>native</b> Android layout managers (i.e. {@link
     * LinearLayoutManager},
    ...
    public static IOverScrollDecor setUpOverScroll(NestedScrollView scrollView) {
        return new VerticalOverScrollBounceEffectDecorator(
                new NestedScrollViewOverScrollDecorAdapter(scrollView));
    }
    ...
    public static IOverScrollDecor setUpOverScroll(CoordinatorLayout coordinatorLayout,
            IOverScrollStateListener stateListener,
            IOverScrollUpdateListener updateListener) {
        return new VerticalOverScrollBounceEffectDecorator(
                new CoordinatorLayoutOverScrollDecorAdapter(
                        coordinatorLayout).setOverScrollStateListener(
                        stateListener).setOverScrollUpdateListener(updateListener));
    }

    public static IOverScrollDecor setUpOverScroll(
            CoordinatorLayout coordinatorLayout, IOverScrollStateListener stateListener,
            IOverScrollUpdateListener updateListener, RecyclerView recyclerView) {
        CoordinatorLayoutOverScrollDecorAdapter adapter =
                new CoordinatorLayoutOverScrollDecorAdapter(coordinatorLayout).initRecyclerView(
                        recyclerView).setOverScrollStateListener(
                        stateListener).setOverScrollUpdateListener(updateListener);
        final VerticalOverScrollBounceEffectDecorator coorDecor =
    ...
    public static IOverScrollDecor setUpOverScroll(
            CoordinatorLayout coordinatorLayout, IOverScrollStateListener stateListener,
            IOverScrollUpdateListener updateListener, NestedScrollView scrollView) {


        CoordinatorLayoutOverScrollDecorAdapter adapter =
                new CoordinatorLayoutOverScrollDecorAdapter(coordinatorLayout).initNestedScrollView(
                        scrollView).setOverScrollStateListener(
                        stateListener).setOverScrollUpdateListener(updateListener);
        ;
        final VerticalOverScrollBounceEffectDecorator coorDecor =
                new VerticalOverScrollBounceEffectDecorator(adapter);
